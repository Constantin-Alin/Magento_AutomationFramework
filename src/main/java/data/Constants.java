...
public class Constants {
   ...
   public static final String FIRST_NAME = "alin";
   public static final String LAST_NAME = "chilom";
   public static final String PASSWORD = "Abcmariutacelmaitare123";
   public static final String CREATE_ACCOUNT_THANKYOU_MESSAGE = "Thank you for registering with Main Website Store.";
   public static final String LOGIN_NAME = "marianpopescu@123.com";
   public static final String LOGIN_PASSWORD = "1234Password";
